...
VALUES
  ...
  (12, 2, 'bridal-day-before-ritual', 'Day-Before Ritual', 'A calm, low-risk session the day before — hydration and glow with no extractions or peels that could leave the skin reactive.', '["1 × Hydra Facial","1 × Glow Peel","1 × Head & Shoulder Massage (30 min)","1 × Eyebrow Threading"]', '[]', NULL, 150, 3999, '/uploads/bridal/day-before-ritual.jpg', 12, 0, 1),
  (13, 2, 'bridal-brow-design', 'Bridal Brow Design', 'Brow mapping and shaping planned around your wedding photographs, with the option of tint or semi-permanent work scheduled far enough ahead to settle.', '["Personalised brow mapping and shaping","Brow Tint or PMU planned to your timeline","Trial and settling time built into the schedule"]', '[]', NULL, NULL, NULL, '/uploads/bridal/bridal-brow-design.jpg', 13, 0, 1),
  (14, 2, 'groom-grooming-package', 'Groom''s Grooming Package', 'Built around the facial hair area — clears irritation and ingrowns, brightens, and finishes hands and feet.', '["1 × Just For Men facial","1 × Full Face Wax","1 × Head Massage (30 min)","1 × Classic Manicure and Classic Pedicure"]', '[]', NULL, NULL, 5499, '/uploads/bridal/grooms-grooming-package.jpg', 14, 1, 1),
  (15, 2, 'groom-glow-course', 'Groom''s Glow Course — 30 Days', 'A month of preparation for grooms dealing with congestion, tan or uneven tone before the wedding.', '["2 × Hydra Facial","1 × Carbon Laser Facial","1 × Full Body Bleach / Detan"]', '[]', NULL, NULL, 8999, '/uploads/bridal/grooms-glow-course-30-days.jpg', 15, 0, 1),
  (16, 2, 'bridesmaid-package', 'Bridesmaid Package', 'A short, well-priced session for the wedding party — clean, bright skin and tidy hands and feet.', '["1 × Hydra Clean Up","1 × Full Face Threading","1 × Classic Manicure","1 × Classic Pedicure"]', '[]', NULL, 120, 3299, '/uploads/bridal/bridesmaid-package.jpg', 16, 0, 1),
  (17, 2, 'mother-of-the-bride-package', 'Mother of the Bride', 'Firming and brightening for mature skin, with body care and a relaxing finish.', '["1 × Upendice Anti Ageing Facial","1 × Full Body Polish","1 × Drupe Manicure and Drupe Pedicure"]', '[]', NULL, NULL, 9499, '/uploads/bridal/mother-of-the-bride.jpg', 17, 0, 1),
  ...
  (24, 4, 'carbon-laser-facial', 'Carbon Laser Facial', 'Q-Switched Nd:YAG laser with a carbon-based lotion to deep-clean, exfoliate and brighten.', '["Q-Switched Nd:YAG laser with carbon-based lotion","Deep-cleans, exfoliates and brightens"]', '[]', NULL, 45, 4000, '/uploads/advanced-facials/carbon-laser-facial.jpg', 24, 1, 1),
  (25, 4, 'meso-glow-therapy', 'Meso Glow Therapy', 'Micro-needling with customised meso-cocktails rich in vitamins, peptides and antioxidants to target dullness, pigmentation and fine lines.', '["Micro-needling with customised meso-cocktails","Targets dullness, pigmentation and fine lines"]', '[]', NULL, 60, 4000, '/uploads/advanced-facials/meso-glow-therapy.jpg', 25, 0, 1),
  (26, 4, 'bb-glow', 'BB Glow — Semi-Permanent Tinted Glow', 'Nano-needling with tinted serums to even out skin tone, boost radiance and reduce pigmentation.', '["Nano-needling with tinted serums","Evens skin tone and boosts radiance","Reduces pigmentation"]', '[]', NULL, 80, 5000, '/uploads/advanced-facials/bb-glow.jpg', 26, 0, 1),
  (27, 4, 'oxygeneo-facial', 'OxyGeneo Facial', 'Triple-action technology — exfoliation, CO₂ oxygenation and active serum infusion for intense rejuvenation.', '["Exfoliation","CO₂ oxygenation","Active serum infusion"]', '[]', NULL, 70, 5000, '/uploads/advanced-facials/oxygeneo-facial.jpg', 27, 0, 1),
  (28, 4, 'vampire-facial', 'Vampire Facial', 'Micro-needling with PRP (Platelet-Rich Plasma) to boost collagen, heal scars and rejuvenate skin.', '["Micro-needling with Platelet-Rich Plasma","Boosts collagen and heals scars"]', '[]', NULL, 60, 5500, '/uploads/advanced-facials/vampire-facial.jpg', 28, 0, 1),
  (29, 4, 'korean-pdrn-glowlift', 'Korean PDRN Glowlift', 'Advanced skin repair and hydration with Salmon DNA (PDRN), delivered by micro- or nano-needling.', '["Advanced repair and hydration with Salmon DNA (PDRN)","Smoother texture and reduced fine lines","Firm, plump skin with deep, dewy hydration","Boosted collagen and product absorption"]', '[]', NULL, 45, 6000, '/uploads/advanced-facials/korean-pdrn-glowlift.jpg', 29, 1, 1),
  (30, 4, 'pumpkin-enzyme-facial', 'Pumpkin Enzyme Facial', 'Power-packed with natural enzymes and AHA to exfoliate, detox and brighten dull, pigmented skin.', '["Natural enzymes and AHA","Exfoliates, detoxes and brightens dull, pigmented skin"]', '[]', NULL, 90, 7000, '/uploads/advanced-facials/pumpkin-enzyme-facial.jpg', 30, 0, 1),
  (31, 4, 'luxe-skin-booster-glow', 'Luxe Skin Booster Glow', 'Micro-needling infusion of high-performance skin boosters to deeply hydrate, brighten and smooth the skin.', '["Micro-needling infusion of high-performance skin boosters","Deeply hydrates, brightens and smooths"]', '[]', NULL, 75, 8000, '/uploads/advanced-facials/luxe-skin-booster-glow.jpg', 31, 0, 1),
  ...
  (200, 5, 'signature-facial', 'Signature Facial', 'A maintenance facial built around cleansing, exfoliation and a treatment mask suited to your skin''s current needs.', '[]', '[]', NULL, 30, NULL, '/uploads/facial/signature_facial.jpg', 1, 0, 1),
  (201, 5, 'lymphatic-facial', 'Lymphatic Facial', 'A sculpting facial that pairs manual lymphatic drainage technique with modern contouring to reduce puffiness and refresh tired skin.', '[]', '[]', NULL, 30, NULL, '/uploads/facial/lymphatic_facial.jpg', 2, 0, 1),
  (202, 5, 'party-prep-facial', 'Party-Prep Facial', 'A pre-event facial using targeted lifting and contouring technology for an immediate, photo-ready glow.', '[]', '[]', NULL, 30, NULL, '/uploads/facial/party_prep_facial.jpg', 3, 0, 1),
  (203, 5, 'just-for-men-facial', 'Just for Men Facial', 'Addresses ingrown hairs, shaving irritation and congestion in the skin beneath facial hair.', '[]', '[]', NULL, 30, NULL, '/uploads/facial/just_for_men_facial.jpg', 4, 0, 1),
  (204, 5, 'estheticians-choice', 'Esthetician''s Choice', 'Your therapist examines your skin first, then builds the facial around what it needs that day.', '[]', '[]', NULL, 50, NULL, '/uploads/facial/esthetician_choice.jpg', 5, 0, 1),
  (205, 5, 'anti-aging-facial', 'Anti-Aging Facial', 'Firming and lifting technology combined with red LED light therapy to stimulate collagen and soften fine lines.', '[]', '[]', NULL, 50, NULL, '/uploads/facial/anti_aging_facial.jpg', 6, 0, 1),
  (206, 5, 'acne-fighting-facial', 'Acne-Fighting Facial', 'A double cleanse with extractions and blue LED light therapy to calm breakouts and target acne-causing bacteria.', '[]', '[]', NULL, 50, NULL, '/uploads/facial/acne_fighting_facial.jpg', 7, 0, 1),
  (207, 5, 'seasonal-hydrating-facial', 'Seasonal Hydrating Facial', 'A climate-adapted mask treatment that protects and repairs the skin barrier as the seasons change.', '[]', '[]', NULL, 50, NULL, '/uploads/facial/seasonal_hydrating_facial.jpg', 8, 0, 1),
  (208, 5, 'hyperpigmentation-facial', 'Hyperpigmentation Facial', 'Green LED light therapy paired with clinical-grade exfoliation to even out tone and fade dark spots.', '[]', '[]', NULL, 50, NULL, '/uploads/facial/hyperpigmentation_facial.jpg', 9, 0, 1),
  (209, 5, 'sensitive-skin-facial', 'Sensitive Skin Facial', 'A calming, low-irritation facial using gentle enzyme exfoliation for reactive or easily-flushed skin.', '[]', '[]', NULL, 50, NULL, '/uploads/facial/sensitive_skin_facial.jpg', 10, 0, 1),
  (210, 5, 'premier-contour-facial', 'Premier Contour Facial', 'A multi-step facial combining dermaplaning, lifting technology, gua sha and LED therapy for the most complete result on the menu.', '[]', '[]', NULL, 90, NULL, '/uploads/facial/premier_contour_facial.jpg', 11, 0, 1),
  ...
  (51, 7, 'dermaplaning', 'Dermaplaning', 'Gentle exfoliation using a surgical blade to remove dead skin and peach fuzz for instant smoothness and glow.', '[]', '[]', NULL, NULL, 1000, '/uploads/facial/dermaplaning.jpg', 51, 0, 1),
  ...
  (53, 7, 'biorepeel', 'BioRepeel', 'A biphasic TCA peel that exfoliates, brightens and stimulates collagen — without visible peeling or downtime.', '[]', '[]', NULL, NULL, 6000, '/uploads/facial/biorepeel.jpg', 53, 0, 1),
  (211, 7, 'hydradermabrasion', 'Hydradermabrasion', 'A diamond-tipped wand resurfaces the skin while infusing hydrating serum — added on to any facial.', '[]', '[]', NULL, 15, NULL, '/uploads/facial/hydradermabrasion.jpg', 211, 0, 1),
  (212, 7, 'extra-extractions', 'Extra Extractions', 'Additional time spent clearing blackheads and congestion from the areas that need it most.', '[]', '[]', NULL, 15, NULL, '/uploads/facial/extra_extractions.jpg', 212, 0, 1),
  (213, 7, 'gua-sha-massage', 'Gua Sha Massage', 'A 30-minute sculpting massage blending traditional gua sha technique with modern tools.', '[]', '[]', NULL, 30, NULL, '/uploads/facial/gua_sha_massage.jpg', 213, 0, 1),
  (214, 7, 'gua-sha-massage-15min', 'Gua Sha Massage (15 min)', 'A shorter version of the gua sha sculpting massage.', '[]', '[]', NULL, 15, NULL, '/uploads/facial/gua_sha_massage.jpg', 214, 0, 1),
  (215, 7, 'custom-jelly-mask', 'Custom Jelly Mask', 'A hydrating peel-off mask finished with hyaluronic acid or collagen.', '[]', '[]', NULL, 15, NULL, '/uploads/facial/custom_jelly_mask.jpg', 215, 0, 1),
  (216, 7, 'lip-plump-and-scrub', 'Lip Plump and Scrub', 'Buffing and red LED light therapy to smooth and plump the lips.', '[]', '[]', NULL, NULL, NULL, '/uploads/facial/lip_plump_and_scrub.jpg', 216, 0, 1),
  (217, 7, 'microcurrent', 'Microcurrent', 'Gentle electrical micro-currents that tone and firm the facial muscles.', '[]', '[]', NULL, 15, NULL, '/uploads/facial/microcurrent.jpg', 217, 0, 1),
  (218, 7, 'eye-puff-minimizer', 'Eye Puff Minimizer', 'A brightening mask and gua sha technique targeting puffiness and dark circles.', '[]', '[]', NULL, NULL, NULL, '/uploads/facial/eye_puff_minimizer.jpg', 218, 0, 1),
  (219, 7, 'neck-firming', 'Neck Firming', 'Electrical stimulation that lifts and tones the neck and décolletage.', '[]', '[]', NULL, NULL, NULL, '/uploads/facial/neck_firming.jpg', 219, 0, 1),
  ...
  (70, 10, 'classic-manicure', 'Classic Manicure', 'Shaping, cuticle care and a polish finish.', '[]', '[]', NULL, 30, 550, '/uploads/manicure/classic.jpg', 70, 0, 1),
  (71, 10, 'oil-manicure', 'Oil Manicure', 'A nourishing warm-oil treatment for dry hands and brittle nails.', '[]', '[]', NULL, 30, 800, '/uploads/manicure/oil.jpg', 71, 0, 1),
  (72, 10, 'pedipie-manicure', 'Pedipie Manicure', 'The Pedipie ritual adapted for hands — cleansing, scrub and mask.', '[]', '[]', NULL, 30, 900, '/uploads/manicure/pedipie.jpg', 72, 0, 1),
  (73, 10, 'algae-manicure', 'Algae Manicure', 'A marine algae treatment that deeply hydrates and firms the skin on the hands.', '[]', '[]', NULL, 45, 2000, '/uploads/manicure/algae.jpg', 73, 0, 1),
  (74, 10, 'drupe-manicure', 'Drupe Manicure', 'A premium Drupe ritual for softness, shine and lasting hydration.', '[]', '[]', NULL, 45, 1500, '/uploads/manicure/drupe.jpg', 74, 1, 1),
  (75, 10, 'drupe-manicure-peel-off-mask', 'Drupe Manicure with Peel Off Mask', 'The Drupe manicure finished with a peel-off mask for extra brightness.', '[]', '[]', NULL, 60, 2000, '/uploads/manicure/drupe-peel-off-mask.jpg', 75, 0, 1),
  (76, 11, 'classic-pedicure', 'Classic Pedicure', 'Soak, shaping, cuticle care, scrub and polish.', '[]', '[]', NULL, 45, 800, '/uploads/pedicure/classic.jpg', 76, 0, 1),
  (77, 11, 'oil-pedicure', 'Oil Pedicure', 'A warm-oil pedicure for dry, cracked heels and tired feet.', '[]', '[]', NULL, 45, 1000, '/uploads/pedicure/oil.jpg', 77, 0, 1),
  (78, 11, 'pedipie-pedicure', 'Pedipie Pedicure', 'The Pedipie ritual — cleansing, scrub and a nourishing mask.', '[]', '[]', NULL, 45, 1200, '/uploads/pedicure/pedipie.jpg', 78, 0, 1),
  (79, 11, 'algae-pedicure', 'Algae Pedicure', 'A marine algae pedicure that hydrates deeply and calms tired feet.', '[]', '[]', NULL, 80, 2500, '/uploads/pedicure/algae.jpg', 79, 0, 1),
  (80, 11, 'drupe-pedicure', 'Drupe Pedicure', 'A premium Drupe pedicure for softness and lasting hydration.', '[]', '[]', NULL, 60, 2000, '/uploads/pedicure/drupe.jpg', 80, 1, 1),
  (81, 11, 'drupe-pedicure-peel-off-mask', 'Drupe Pedicure with Peel Off Mask', 'The Drupe pedicure finished with a peel-off mask.', '[]', '[]', NULL, 80, 2500, '/uploads/pedicure/drupe-peel-off-mask.jpg', 81, 0, 1),
  ...
  (95, 14, 'underarms-wax', 'Underarms', 'Choose hot wax, Rica or peel-off for the underarm area.', '[]', '[]', NULL, NULL, 100, '/uploads/body-waxing/underarms.jpg', 95, 0, 1),
  (96, 14, 'full-arms-wax', 'Full Arms', 'Full arm waxing in hot wax or Rica.', '[]', '[]', NULL, NULL, 300, '/uploads/body-waxing/full-arms.jpg', 96, 0, 1),
  (97, 14, 'half-legs-wax', 'Half Legs', 'Knee-down waxing in hot wax or Rica.', '[]', '[]', NULL, NULL, 300, '/uploads/body-waxing/half-legs.jpg', 97, 0, 1),
  (98, 14, 'full-legs-wax', 'Full Legs', 'Full leg waxing in hot wax or Rica.', '[]', '[]', NULL, NULL, 550, '/uploads/body-waxing/full-legs.jpg', 98, 1, 1),
  (99, 14, 'stomach-wax', 'Stomach', 'Stomach waxing in hot wax or Rica.', '[]', '[]', NULL, NULL, 350, '/uploads/body-waxing/stomach.jpg', 99, 0, 1),
  (100, 14, 'bums-wax', 'Bums Wax', 'Waxing for the bum area in hot wax or Rica.', '[]', '[]', NULL, NULL, 400, '/uploads/body-waxing/bums.jpg', 100, 0, 1),
  (101, 14, 'full-back-wax', 'Full Back', 'Full back waxing in hot wax or Rica.', '[]', '[]', NULL, NULL, 550, '/uploads/body-waxing/full-back.jpg', 101, 0, 1),
  (102, 14, 'bikini-wax', 'Bikini', 'Bikini waxing with hot wax, Rica or peel-off for maximum comfort.', '[]', '[]', NULL, NULL, 1000, '/uploads/body-waxing/bikini.jpg', 102, 0, 1),
  (103, 14, 'full-body-wax', 'Full Body', 'Full body waxing. Bikini and bums are not included.', '[]', '[]', NULL, NULL, 1800, '/uploads/body-waxing/full-body.jpg', 103, 0, 1),
  (104, 14, 'full-face-wax-rica', 'Full Face Wax (Rica)', 'Full face waxing in Rica wax.', '[]', '[]', NULL, NULL, 650, '/services/21339.jpg', 104, 0, 1),
  (105, 15, 'nailcut-filing-polish', 'Nailcut, Filing and Polish', 'Nail shaping, filing and a polish finish.', '[]', '[]', NULL, 15, 250, '/uploads/nails/nailcut-filing-polish.jpg', 105, 0, 1),
  (106, 15, 'paraffin-wax-add-on', 'Paraffin Wax Add On', 'A warm paraffin wrap that softens hands or feet — added to any manicure or pedicure.', '[]', '[]', NULL, 15, 300, '/uploads/nails/paraffin-wax-add-on.jpg', 106, 0, 1),
  ...
  (108, 16, 'hand-massage', 'Hand Massage', 'A gentle treatment that eases stiffness and strain from the hands.', '["Improved mobility","Relief from muscle fatigue","Enhanced blood circulation"]', '[]', NULL, 20, 400, '/uploads/massages/hand-massage.jpg', 108, 0, 1),
  ...
  (112, 16, 'face-massage', 'Face Massage', 'A gentle, rejuvenating therapy that boosts glow and relaxation.', '["Enhanced blood flow","Reduced puffiness","Improved skin texture"]', '[]', NULL, 20, 600, '/uploads/massages/face-massage.jpg', 112, 0, 1),
