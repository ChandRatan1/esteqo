...
VALUES
  (1, 1, 'brow-shape', 'Brow Shape', 'Personalised brow mapping combined with precision grooming to create a shape that complements your facial proportions, eye shape and natural brow growth.', '["Customised brow design, not a standard template","Natural brow preservation — density is protected wherever possible","Threading, waxing, tweezing and trimming combined as your brows need","No downtime — return to your routine immediately"]', '[]', 'Want cleaner, more defined eyebrows • Feel their brows lack structure or symmetry • Have thick, unruly or uneven brow hair • Want to refine their natural arch • Need regular professional brow maintenance • Have previously over-plucked their eyebrows • Want a professionally mapped shape before a PMU treatment', 20, NULL, '/uploads/brows/brow_shape.jpg', 1, 1, 1, NULL),
  (2, 1, 'brow-tint', 'Brow Tint', 'A temporary colour treatment that deepens your natural brow hair for a more defined, fuller-looking finish — without committing to permanent makeup.', '["Shade selected around your natural colouring, not simply darkened","Controlled application that respects the existing brow shape","Professional formulations — vegan, cruelty-free, paraben-free and PPD-free options may be available","Minimal aftercare and no downtime"]', '[]', 'Want their brows to appear darker and more defined • Have naturally light or unevenly coloured brow hair • Want to create a fuller-looking appearance • Would like their brows to complement a new hair colour • Prefer a low-maintenance alternative to daily brow makeup • Want temporary enhancement without permanent makeup', 20, NULL, '/uploads/brows/brow_tint.jpg', 2, 1, 1, NULL),
  (3, 1, 'hd-brows', 'HD Brows', 'A multi-step brow treatment combining mapping, tinting and precision shaping to build a fuller, high-definition brow.', '[]', '[]', NULL, NULL, NULL, '/uploads/brows/hd_brows.jpg', 3, 0, 1, NULL),
  (4, 1, 'brow-lamination', 'Brow Lamination', 'A restructuring treatment that lifts and sets brow hairs upward for a fuller, groomed look that lasts for weeks.', '[]', '[]', NULL, NULL, NULL, '/uploads/brows/brow_lamination.jpg', 4, 0, 1, NULL),
  (5, 1, 'microblading', 'Microblading', 'Hair-stroke semi-permanent pigment applied by hand to fill sparse areas and rebuild a natural, defined brow.', '[]', '[]', NULL, NULL, NULL, '/uploads/brows/microblading.jpg', 5, 0, 1, NULL),
  (6, 1, 'ombre-brow', 'Ombre Brow', 'A soft, machine-shaded permanent makeup technique creating a powdered finish with a light-to-dark gradient.', '[]', '[]', NULL, NULL, NULL, '/uploads/brows/ombre_brow.jpg', 6, 0, 1, NULL),
  (7, 1, 'hybrid-brow', 'Hybrid Brow', 'Microblading hair strokes combined with soft shading — definition at the tail with a natural gradient at the front.', '[]', '[]', NULL, NULL, NULL, '/uploads/brows/hybrid_brow.jpg', 7, 0, 1, NULL),
  (8, 1, 'brow-tattoo-removal', 'Tattoo Removal', 'Corrective work that lightens or neutralises unwanted brow pigment from previous permanent makeup, before the brow is rebuilt.', '[]', '[]', NULL, NULL, NULL, '/uploads/brows/tattoo-removal.jpg', 8, 0, 1, NULL),
